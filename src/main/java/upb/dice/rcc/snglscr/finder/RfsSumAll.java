...
/**
 * Implementation for {@link RccFinderSngl}. This class sums up vectors of all the
 ...
 *
 */
public class RfsSumAll extends RccFinderSngl {

	public static Logger LOG = LogManager.getLogger(RfsSumAll.class);
	/**
	...
	/**
	 * @see RccFinderSngl#RccFinder(Word2VecModel, GenWord2VecModel,
	 *      PublicationWordSetExtractor)
	 */
	public RfsSumAll(Word2VecModel genModel, GenWord2VecModel memModel,
